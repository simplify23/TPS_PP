...
train_img_prefix1 = f'{train_root}/SynthText/' + \
    'synthtext/SynthText_patch_horizontal'
train_ann_file1 = f'{train_root}/SynthText/shuffle_labels.lmdb'
train1 = dict(
    type='OCRDataset',
...
#     'synthtext/SynthText_patch_horizontal'
# train_ann_file2 = f'{train_root}/SynthText/shuffle_labels.lmdb'
#
